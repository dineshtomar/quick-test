...
export class TestCaseEntity extends AbstractEntity<TestCaseDto> {
    ...
    @ManyToOne(() => ProjectEntity, (project) => project.testcases,{ onDelete:"CASCADE" })
    ...
    @Column({ type: "enum", enum: ExecutionPriority , default: ExecutionPriority.MEDIUM, nullable: false })
