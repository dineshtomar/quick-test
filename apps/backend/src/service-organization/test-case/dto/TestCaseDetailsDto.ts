...
export class TestCaseDetailsDto extends AbstractDto {
    ...
    constructor(testcase: TestCaseEntity) {
        ...
        this.project = testcase.project 
            ? testcase.project.toDto()
            : undefined;
        this.section = testcase.section ? testcase.section.toDto() : undefined;
        this.createdBy = testcase.createdBy ? testcase.createdBy.toDto() : undefined;
        this.updatedBy = testcase.updatedBy ? testcase.updatedBy.toDto() : undefined;
        this.executionPriority = testcase.executionPriority ? testcase.executionPriority : ExecutionPriority.LOW;
