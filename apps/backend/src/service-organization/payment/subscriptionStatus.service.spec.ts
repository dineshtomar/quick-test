     ...
     */
     ...
     describe("createSubscriptionStatus", () => {
        it("should create a subscription status", async () => {
            ...
            mocked(subscriptionStatusService.createSubscriptionStatus).mockImplementation(() =>
                Promise.resolve((mockedSubscriptionStatus as unknown) as true)
            );
            expect(
                await subscriptionStatusService.createSubscriptionStatus( mockedSubscriptionStatus)
        ...
        it("should return error if creating subscription status fails", async () => {
            ...
            expect(
                subscriptionStatusService.createSubscriptionStatus(mockedSubscriptionStatus)
