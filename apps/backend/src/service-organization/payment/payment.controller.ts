import { Controller, Get, HttpCode, HttpStatus, Post,  Req, Request, UseFilters, UseGuards, UseInterceptors } from "@nestjs/common";
...
export class PaymentController {
    ...
    */
    ...
    async customerPortal(@AuthUser() user: UserEntity): Promise<ResponseSuccess>{
        const sessionUrl = await this.paymentService.createCustomerPortalSession(user);
