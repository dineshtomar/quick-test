...
import { CreateTestSuiteDto, CreateTestSuiteSwagger, testSuiteIdsSwagger } from "../../test-suite/dto/CreateTestSuiteDto";
import { EditTestSuiteDto } from "../../test-suite/dto/EditTestSuiteDto";
import { TestSuiteDto } from "../../test-suite/dto/TestSuiteDto";
import { CreateFilteredTestSuiteDto, CreateFilteredTestSuiteSwagger } from "../../test-suite/dto/CreateFilteredTestSuiteDto";
...
export class TestsuiteRelatedProjectController {
    ...
    @ApiResponse({
        status: HttpStatus.CREATED,
        description: "Creates a new Test Suite with filtered sections and test cases",
