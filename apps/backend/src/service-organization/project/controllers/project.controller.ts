...
export class ProjectController {
    ...
    async getProjectTodo(
        ...
        const res = await this._projectReadService.getProjectTodo(
            projectId,
            user
        );
    ...
    async getFavoriteProjects(
        ...
        const favoriteProjects = await this._projectReadService.getFavoriteProjects(
            user
        );
        return new ResponseSuccess("translations.FAVORITE_PROJECTS", favoriteProjects);
    }
    ...
    async addFavoriteProject(
        ...
        return new ResponseSuccess("translations.FAVORITE_PROJECT_CREATED", favoriteProject);
    }
    ...
    async removeFavoriteProject(
        ...
        const favoriteProject = await this._projectDeleteService.removeFavoriteProject(
            projectId, 
            user
        );
        return new ResponseSuccess("translations.FAVORITE_PROJECT_REMOVED", favoriteProject);
    }
}
