...
describe("ProjectCreateService", () => {
    ...
    beforeEach(async () => {
        ...
        projectCreateService = module.get<ProjectCreateService>(ProjectCreateService);
    });
    ...
    describe("createTestCase", () => {
        it("it should create a TestCase", () => {
            ...
            mocked(projectCreateService.createTestCase).mockImplementation(() => Promise.resolve(mockTestCaseDto))
            expect(
                projectCreateService.createTestCase(
                    mockTestCaseDto,
                    mockProject.id,
                    sectionId,
                    mockedUser
