...
describe("RoleService", () => {
    ...
    describe("createRole", () => {
        it("it should create a Role", () => {
            mocked(roleService.createRole).mockImplementation(() => Promise.resolve(mockRoleDto))
            expect(
    ...
    */ 
    ...
    describe("findRoleById", () => {
        ...
        it("should return the role for specific ID", async () => {
            mocked(roleService.findRoleById).mockImplementation(async() => 
                await Promise.resolve((mockedRole as unknown) as RoleEntity)
            );    
    ...
    describe("findByRoleType", () => {
        it("should return the roleType", async () => {
            mocked(roleService.findByRoleType).mockImplementation(async() => 
                await Promise.resolve((mockedRole as unknown) as RoleEntity)
            );    
    
            await expect(
                roleService.findByRoleType(
