import { Column, Entity, ManyToOne, JoinColumn, OneToMany, ManyToMany, JoinTable, DeleteDateColumn } from "typeorm";
...
export class UserEntity extends AbstractEntity<UserDto> {
    ...
    @OneToMany(() => TestSuiteEntity, (testsuites) => testsuites.user,{ cascade: true })
    ...
    @OneToMany(() => TestSuiteEntity, (assignedTestsuites) => assignedTestsuites.assignedTo,{ cascade:true })
    assignedTestsuites: TestSuiteEntity[];

    @OneToMany(() => ActivityEntity, (activity) => activity.user, { cascade:true })
