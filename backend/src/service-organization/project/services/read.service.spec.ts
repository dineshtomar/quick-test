...
describe("ProjectReadService", () => {
    ...
    describe("findOne", () => {
        it("should find one Project", async() => {
            mocked(projectReadService.findOne).mockImplementation(async () => await Promise.resolve((mockProject as unknown) as ProjectEntity))
    ...
    describe("getProject", () => {
        it("should return a single project", async () => {
            ...
            expect(await projectReadService.getProject(result.id, mockedUser)).toMatchObject(result)
        });
    ...
    */ 
    ...
    describe('getProjects', () => {
        it("should return all projects", async () => {
            mocked(projectReadService.getProjects).mockImplementation(async() => Promise.resolve((mockedFavoriteProjects as unknown) as ProjectsPageDto))
            return await projectReadService.getProjects(mockPageOptionsDto, mockedUser).then((data) => {
    ...
    */ 
    ...
    describe("checkProjectWithSameName", () => {
        it("should return true", async () => {
            mocked(projectReadService.checkProjectWithSameName).mockImplementation(() => Promise.resolve(true))
            return projectReadService.checkProjectWithSameName(
                mockProject.name, 
    ...
    describe("getAllProjects", () => {
        it("should return error for project not found", async () => {
            mocked(projectReadService.getAllProjects).mockImplementation(() => 
                Promise.reject(
                    new Error("No projects were found")
                )
            );    
    ...
    describe("getMostActiveProjects", () => {
        it("should return 4 most active projects", async () => {
            ...
            mocked(projectReadService.getMostActiveProjects).mockImplementation(() => 
                Promise.resolve((mockedActiveProject as unknown) as MostActiveProjectListDto[])
            );    
            ...
            expect(
                projectReadService.getMostActiveProjects(
                    pageOptionsDto,
                    mockedUser
                )
    ...
    describe("findAllProjectsWithTestChanges", () => {
        it("should return error if no projects were found with test changes", async () => {
            mocked(projectReadService.findAllProjectsWithTestChanges).mockImplementation(() => 
                Promise.reject(
                    new Error("No projects were found")
                )
            );    
        ...
        it("should return all projects with total test changes", async () => {
            ...
            mocked(projectReadService.findAllProjectsWithTestChanges).mockImplementation(() => 
                Promise.resolve((mockedActiveProject as unknown) as MostActiveProjectDto[])
            );    
     ...
     */
     describe("getFavoriteProjects", () => {
        it("should return error if no favorite projects were found for the user", async () => {
            ...
            expect(
                projectReadService.getFavoriteProjects(
                    mockedUser
                )
        ...
        it("should return all favorite projects for the user", async () => {
            ...
            const favoriteProjects = mockedFavoriteProjects.filter(project => project.favorite);
     ...
     describe("getArchivedProjects", () => {
        it("should return error for project not found", async () => {
            mocked(projectReadService.getArchivedProjects).mockImplementation(() => 
                Promise.reject(
                    new Error("No archived projects were found")
                )
            );    
