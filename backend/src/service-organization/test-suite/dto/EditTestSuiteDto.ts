...
import { IsOptional, IsNotEmpty, MaxLength, IsEnum, IsUUID } from "class-validator";
...
export class EditTestSuiteDto {
    ...
    @IsEnum(() => TestSuiteStatus, { message: "Test Suite can be INPROGRESS or COMPLETED or PENDING only" })
