...
export default registerAs<PdfConfig>('pdf', () => {
    ...
    return {
            ...
            titleLeftMargin: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_LEFT_MARGIN),
            ...
            invoiceHeight: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_INVOICE_HEIGHT),
            billingAddressHeight: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_BILLING_ADDRESS_HEIGHT),
            billingAddressStart: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_BILLING_ADDRESS_START),
            purchaseDetailsLeftMargin: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_PURCHASE_DETAILS_LEFT_MARGIN),
            headingsHeight: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_HEADINGS_HEIGHT),
            headingsStart: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_HEADINGS_START),
            quantityLeftMargin: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_QUANTITY_LEFT_MARGIN),
            quantityWdith: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_QUANTITY_WIDTH),
            descriptionWidth: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_DESCRIPTION_WIDTH),
            detailsHeight: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_DETAILS_HEIGHT),
            ...
            endLeftMargin: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_END_LEFT_MARGIN),
            ...
            policyLine1Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_1_START),
            policyLine2Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_2_START),
            policyLine3Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_3_START),
            policyLine4Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_4_START),
            policyLine5Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_5_START),
            policyLine6Start: Number(process.env.PAYMENT_SUCCESS_INVOICE_PDF_POLICY_LINE_6_START)
    }  
})